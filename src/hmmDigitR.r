...
initAllHMMsDigit <- function(nbrEtats){
  print("Initialisation des HMMs :")
  
  ### Pour 5x3
  print("Initialisation des HMMs 5x3")
  HMM0_5x3 = initHMMDigit(nbrEtats,15)
  HMM1_5x3 = initHMMDigit(nbrEtats,15)
  HMM2_5x3 = initHMMDigit(nbrEtats,15)
  HMM3_5x3 = initHMMDigit(nbrEtats,15)
  HMM4_5x3 = initHMMDigit(nbrEtats,15)
  HMM5_5x3 = initHMMDigit(nbrEtats,15)
  HMM6_5x3 = initHMMDigit(nbrEtats,15)
  HMM7_5x3 = initHMMDigit(nbrEtats,15)
  HMM8_5x3 = initHMMDigit(nbrEtats,15)
  HMM9_5x3 = initHMMDigit(nbrEtats,15)
  
  ### Pour 5x4
  print("Initialisation des HMMs 5x4")
  HMM0_5x4 = initHMMDigit(nbrEtats,20)
  HMM1_5x4 = initHMMDigit(nbrEtats,20)
  HMM2_5x4 = initHMMDigit(nbrEtats,20)
  HMM3_5x4 = initHMMDigit(nbrEtats,20)
  HMM4_5x4 = initHMMDigit(nbrEtats,20)
  HMM5_5x4 = initHMMDigit(nbrEtats,20)
  HMM6_5x4 = initHMMDigit(nbrEtats,20)
  HMM7_5x4 = initHMMDigit(nbrEtats,20)
  HMM8_5x4 = initHMMDigit(nbrEtats,20)
  HMM9_5x4 = initHMMDigit(nbrEtats,20)
  
  ### Pour 8
  print("Initialisation des HMMs 8")
  HMM0_8 = initHMMDigit(nbrEtats,8)
  HMM1_8 = initHMMDigit(nbrEtats,8)
  HMM2_8 = initHMMDigit(nbrEtats,8)
  HMM3_8 = initHMMDigit(nbrEtats,8)
  HMM4_8 = initHMMDigit(nbrEtats,8)
  HMM5_8 = initHMMDigit(nbrEtats,8)
  HMM6_8 = initHMMDigit(nbrEtats,8)
  HMM7_8 = initHMMDigit(nbrEtats,8)
  HMM8_8 = initHMMDigit(nbrEtats,8)
  HMM9_8 = initHMMDigit(nbrEtats,8)
  
  ### Pour 16
  print("Initialisation des HMMs 16")
  HMM0_16 = initHMMDigit(nbrEtats,16)
  HMM1_16 = initHMMDigit(nbrEtats,16)
  HMM2_16 = initHMMDigit(nbrEtats,16)
  HMM3_16 = initHMMDigit(nbrEtats,16)
  HMM4_16 = initHMMDigit(nbrEtats,16)
  HMM5_16 = initHMMDigit(nbrEtats,16)
  HMM6_16 = initHMMDigit(nbrEtats,16)
  HMM7_16 = initHMMDigit(nbrEtats,16)
  HMM8_16 = initHMMDigit(nbrEtats,16)
  HMM9_16 = initHMMDigit(nbrEtats,16)
}

loadTrainingObservation <- function(){
...
reloadHmmsAlreadyTrain <- function(){
