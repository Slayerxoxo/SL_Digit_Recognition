...
leHMM_5X3 = list(m0=tmp0, m1=tmp1, m2=tmp2, m3=tmp3, m4=tmp4, m5=tmp5, m6=tmp6, m7=tmp7, m8=tmp8, m9=tmp9)

save(leHMM_5X3, file = 'C:/Users/Coraline/Documents/Cora-Cours/SL_Digit_Recognition/src/Results/HMM_5x3_entraine.rdata')

# si ca marche faire pareil pour :
# leHMM_5X4 = c()
# leHMM_8 = c()
# leHMM_16 = c()
...
reco_rate0 <- classifyDigit(test0,leHMM_5X3)
